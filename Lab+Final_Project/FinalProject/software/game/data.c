...
const long long unsigned int event_c_jump2[4][6] = {
    {13, 0x3f90, 3, 1, 0, 0},                 // prohibition vector: 0011 1111 1001 0000
    {9, 0x0001f1a222300000, 34, 35, 8, 24},   // character_double_jump3
    {8, 0x0001f02182200000, 24, 34, 8, 15},   // character_double_jump1
    {5, 0x0001eed152500000, 21, 37, 10, 16}   // character_double_jump2
}; 
