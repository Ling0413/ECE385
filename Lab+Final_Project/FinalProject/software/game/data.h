...
extern const int f_jump2;
extern const int f_jump_press;
...
extern const long long unsigned int event_c_jump2[4][6];
...
extern const long long unsigned int event_s_spine[8][6];
