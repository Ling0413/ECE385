...
module lab8_soc_mm_interconnect_0 (
		...
		output wire [4:0]  GameControl_GameControl_Slave_address,          //            GameControl_GameControl_Slave.address
		output wire        GameControl_GameControl_Slave_write,            //                                         .write
		output wire        GameControl_GameControl_Slave_read,             //                                         .read
		input  wire [63:0] GameControl_GameControl_Slave_readdata,         //                                         .readdata
		output wire [63:0] GameControl_GameControl_Slave_writedata,        //                                         .writedata
		output wire [7:0]  GameControl_GameControl_Slave_byteenable,       //                                         .byteenable
		output wire        GameControl_GameControl_Slave_chipselect,       //                                         .chipselect
	...
	wire   [63:0] gamecontrol_gamecontrol_slave_agent_m0_readdata;                                    // GameControl_GameControl_Slave_translator:uav_readdata -> GameControl_GameControl_Slave_agent:m0_readdata
	wire          gamecontrol_gamecontrol_slave_agent_m0_waitrequest;                                 // GameControl_GameControl_Slave_translator:uav_waitrequest -> GameControl_GameControl_Slave_agent:m0_waitrequest
	wire          gamecontrol_gamecontrol_slave_agent_m0_debugaccess;                                 // GameControl_GameControl_Slave_agent:m0_debugaccess -> GameControl_GameControl_Slave_translator:uav_debugaccess
	wire   [28:0] gamecontrol_gamecontrol_slave_agent_m0_address;                                     // GameControl_GameControl_Slave_agent:m0_address -> GameControl_GameControl_Slave_translator:uav_address
	wire    [7:0] gamecontrol_gamecontrol_slave_agent_m0_byteenable;                                  // GameControl_GameControl_Slave_agent:m0_byteenable -> GameControl_GameControl_Slave_translator:uav_byteenable
	wire          gamecontrol_gamecontrol_slave_agent_m0_read;                                        // GameControl_GameControl_Slave_agent:m0_read -> GameControl_GameControl_Slave_translator:uav_read
	wire          gamecontrol_gamecontrol_slave_agent_m0_readdatavalid;                               // GameControl_GameControl_Slave_translator:uav_readdatavalid -> GameControl_GameControl_Slave_agent:m0_readdatavalid
	wire          gamecontrol_gamecontrol_slave_agent_m0_lock;                                        // GameControl_GameControl_Slave_agent:m0_lock -> GameControl_GameControl_Slave_translator:uav_lock
	wire   [63:0] gamecontrol_gamecontrol_slave_agent_m0_writedata;                                   // GameControl_GameControl_Slave_agent:m0_writedata -> GameControl_GameControl_Slave_translator:uav_writedata
	wire          gamecontrol_gamecontrol_slave_agent_m0_write;                                       // GameControl_GameControl_Slave_agent:m0_write -> GameControl_GameControl_Slave_translator:uav_write
	wire    [3:0] gamecontrol_gamecontrol_slave_agent_m0_burstcount;                                  // GameControl_GameControl_Slave_agent:m0_burstcount -> GameControl_GameControl_Slave_translator:uav_burstcount
	wire          gamecontrol_gamecontrol_slave_agent_rf_source_valid;                                // GameControl_GameControl_Slave_agent:rf_source_valid -> GameControl_GameControl_Slave_agent_rsp_fifo:in_valid
	wire  [144:0] gamecontrol_gamecontrol_slave_agent_rf_source_data;                                 // GameControl_GameControl_Slave_agent:rf_source_data -> GameControl_GameControl_Slave_agent_rsp_fifo:in_data
	wire          gamecontrol_gamecontrol_slave_agent_rf_source_ready;                                // GameControl_GameControl_Slave_agent_rsp_fifo:in_ready -> GameControl_GameControl_Slave_agent:rf_source_ready
	wire          gamecontrol_gamecontrol_slave_agent_rf_source_startofpacket;                        // GameControl_GameControl_Slave_agent:rf_source_startofpacket -> GameControl_GameControl_Slave_agent_rsp_fifo:in_startofpacket
	wire          gamecontrol_gamecontrol_slave_agent_rf_source_endofpacket;                          // GameControl_GameControl_Slave_agent:rf_source_endofpacket -> GameControl_GameControl_Slave_agent_rsp_fifo:in_endofpacket
	wire          gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_valid;                             // GameControl_GameControl_Slave_agent_rsp_fifo:out_valid -> GameControl_GameControl_Slave_agent:rf_sink_valid
	wire  [144:0] gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_data;                              // GameControl_GameControl_Slave_agent_rsp_fifo:out_data -> GameControl_GameControl_Slave_agent:rf_sink_data
	wire          gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_ready;                             // GameControl_GameControl_Slave_agent:rf_sink_ready -> GameControl_GameControl_Slave_agent_rsp_fifo:out_ready
	wire          gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_startofpacket;                     // GameControl_GameControl_Slave_agent_rsp_fifo:out_startofpacket -> GameControl_GameControl_Slave_agent:rf_sink_startofpacket
	wire          gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_endofpacket;                       // GameControl_GameControl_Slave_agent_rsp_fifo:out_endofpacket -> GameControl_GameControl_Slave_agent:rf_sink_endofpacket
	...
	wire          gamecontrol_gamecontrol_slave_agent_rp_valid;                                       // GameControl_GameControl_Slave_agent:rp_valid -> router_002:sink_valid
	wire  [143:0] gamecontrol_gamecontrol_slave_agent_rp_data;                                        // GameControl_GameControl_Slave_agent:rp_data -> router_002:sink_data
	wire          gamecontrol_gamecontrol_slave_agent_rp_ready;                                       // router_002:sink_ready -> GameControl_GameControl_Slave_agent:rp_ready
	wire          gamecontrol_gamecontrol_slave_agent_rp_startofpacket;                               // GameControl_GameControl_Slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          gamecontrol_gamecontrol_slave_agent_rp_endofpacket;                                 // GameControl_GameControl_Slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> GameControl_GameControl_Slave_cmd_width_adapter:in_valid
	wire  [107:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> GameControl_GameControl_Slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                  // GameControl_GameControl_Slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire   [13:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> GameControl_GameControl_Slave_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> GameControl_GameControl_Slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> GameControl_GameControl_Slave_cmd_width_adapter:in_endofpacket
	wire          gamecontrol_gamecontrol_slave_cmd_width_adapter_src_valid;                          // GameControl_GameControl_Slave_cmd_width_adapter:out_valid -> GameControl_GameControl_Slave_agent:cp_valid
	wire  [143:0] gamecontrol_gamecontrol_slave_cmd_width_adapter_src_data;                           // GameControl_GameControl_Slave_cmd_width_adapter:out_data -> GameControl_GameControl_Slave_agent:cp_data
	wire          gamecontrol_gamecontrol_slave_cmd_width_adapter_src_ready;                          // GameControl_GameControl_Slave_agent:cp_ready -> GameControl_GameControl_Slave_cmd_width_adapter:out_ready
	wire   [13:0] gamecontrol_gamecontrol_slave_cmd_width_adapter_src_channel;                        // GameControl_GameControl_Slave_cmd_width_adapter:out_channel -> GameControl_GameControl_Slave_agent:cp_channel
	wire          gamecontrol_gamecontrol_slave_cmd_width_adapter_src_startofpacket;                  // GameControl_GameControl_Slave_cmd_width_adapter:out_startofpacket -> GameControl_GameControl_Slave_agent:cp_startofpacket
	wire          gamecontrol_gamecontrol_slave_cmd_width_adapter_src_endofpacket;                    // GameControl_GameControl_Slave_cmd_width_adapter:out_endofpacket -> GameControl_GameControl_Slave_agent:cp_endofpacket
	wire          router_002_src_valid;                                                               // router_002:src_valid -> GameControl_GameControl_Slave_rsp_width_adapter:in_valid
	wire  [143:0] router_002_src_data;                                                                // router_002:src_data -> GameControl_GameControl_Slave_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                               // GameControl_GameControl_Slave_rsp_width_adapter:in_ready -> router_002:src_ready
	wire   [13:0] router_002_src_channel;                                                             // router_002:src_channel -> GameControl_GameControl_Slave_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                                       // router_002:src_startofpacket -> GameControl_GameControl_Slave_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                         // router_002:src_endofpacket -> GameControl_GameControl_Slave_rsp_width_adapter:in_endofpacket
	wire          gamecontrol_gamecontrol_slave_rsp_width_adapter_src_valid;                          // GameControl_GameControl_Slave_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [107:0] gamecontrol_gamecontrol_slave_rsp_width_adapter_src_data;                           // GameControl_GameControl_Slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          gamecontrol_gamecontrol_slave_rsp_width_adapter_src_ready;                          // rsp_demux:sink_ready -> GameControl_GameControl_Slave_rsp_width_adapter:out_ready
	wire   [13:0] gamecontrol_gamecontrol_slave_rsp_width_adapter_src_channel;                        // GameControl_GameControl_Slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          gamecontrol_gamecontrol_slave_rsp_width_adapter_src_startofpacket;                  // GameControl_GameControl_Slave_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          gamecontrol_gamecontrol_slave_rsp_width_adapter_src_endofpacket;                    // GameControl_GameControl_Slave_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	...
	wire          gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_valid;                           // GameControl_GameControl_Slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [65:0] gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_data;                            // GameControl_GameControl_Slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_ready;                           // avalon_st_adapter:in_0_ready -> GameControl_GameControl_Slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> GameControl_GameControl_Slave_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> GameControl_GameControl_Slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                      // GameControl_GameControl_Slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> GameControl_GameControl_Slave_agent:rdata_fifo_sink_error
	...
	) gamecontrol_gamecontrol_slave_translator (
		.clk                    (clk_0_clk_clk),                                        //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset),       //                    reset.reset
		.uav_address            (gamecontrol_gamecontrol_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (gamecontrol_gamecontrol_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (gamecontrol_gamecontrol_slave_agent_m0_read),          //                         .read
		.uav_write              (gamecontrol_gamecontrol_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (gamecontrol_gamecontrol_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (gamecontrol_gamecontrol_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (gamecontrol_gamecontrol_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (gamecontrol_gamecontrol_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (gamecontrol_gamecontrol_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (gamecontrol_gamecontrol_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (gamecontrol_gamecontrol_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (GameControl_GameControl_Slave_address),                //      avalon_anti_slave_0.address
		.av_write               (GameControl_GameControl_Slave_write),                  //                         .write
		.av_read                (GameControl_GameControl_Slave_read),                   //                         .read
		.av_readdata            (GameControl_GameControl_Slave_readdata),               //                         .readdata
		.av_writedata           (GameControl_GameControl_Slave_writedata),              //                         .writedata
		.av_byteenable          (GameControl_GameControl_Slave_byteenable),             //                         .byteenable
		.av_chipselect          (GameControl_GameControl_Slave_chipselect),             //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) gamecontrol_gamecontrol_slave_agent (
		.clk                     (clk_0_clk_clk),                                                     //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                    //       clk_reset.reset
		.m0_address              (gamecontrol_gamecontrol_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (gamecontrol_gamecontrol_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (gamecontrol_gamecontrol_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (gamecontrol_gamecontrol_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (gamecontrol_gamecontrol_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (gamecontrol_gamecontrol_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (gamecontrol_gamecontrol_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (gamecontrol_gamecontrol_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (gamecontrol_gamecontrol_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (gamecontrol_gamecontrol_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (gamecontrol_gamecontrol_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (gamecontrol_gamecontrol_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (gamecontrol_gamecontrol_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (gamecontrol_gamecontrol_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (gamecontrol_gamecontrol_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (gamecontrol_gamecontrol_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_ready),         //              cp.ready
		.cp_valid                (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_valid),         //                .valid
		.cp_data                 (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_data),          //                .data
		.cp_startofpacket        (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_startofpacket), //                .startofpacket
		.cp_endofpacket          (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_endofpacket),   //                .endofpacket
		.cp_channel              (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_channel),       //                .channel
		.rf_sink_ready           (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (gamecontrol_gamecontrol_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (gamecontrol_gamecontrol_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (gamecontrol_gamecontrol_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (gamecontrol_gamecontrol_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (gamecontrol_gamecontrol_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                     //                .error
		.rdata_fifo_src_ready    (gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_data),           //                .data
	...
	) gamecontrol_gamecontrol_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                 // clk_reset.reset
		.in_data           (gamecontrol_gamecontrol_slave_agent_rf_source_data),             //        in.data
		.in_valid          (gamecontrol_gamecontrol_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (gamecontrol_gamecontrol_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (gamecontrol_gamecontrol_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (gamecontrol_gamecontrol_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (gamecontrol_gamecontrol_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	lab8_soc_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (gamecontrol_gamecontrol_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (gamecontrol_gamecontrol_slave_agent_rp_valid),         //          .valid
		.sink_data          (gamecontrol_gamecontrol_slave_agent_rp_data),          //          .data
		.sink_startofpacket (gamecontrol_gamecontrol_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (gamecontrol_gamecontrol_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                     //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		.sink_ready         (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) gamecontrol_gamecontrol_slave_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                     //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (gamecontrol_gamecontrol_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) gamecontrol_gamecontrol_slave_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                     //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (gamecontrol_gamecontrol_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                             // (terminated)
	);
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (gamecontrol_gamecontrol_slave_agent_rdata_fifo_src_ready), //         .ready
